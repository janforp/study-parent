...
public class AVLTreeWith34<K extends Comparable<K>, V> {
    ...
    public void test() {
        ...
        tree.add(5, "5");
        tree.add(6, "6");
        Node node5 = (Node) tree.getNode(5);
        Assert.assertNotNull(node5);
        Assert.assertEquals(6, node5.right.key);
        tree.add(7, "7");
        Assert.assertNull(node5.left);
        Assert.assertNull(node5.right);

        Node node6 = (Node) tree.getNode(6);
        Assert.assertEquals(5, node6.left.key);
        Assert.assertEquals(7, node6.right.key);

        tree.add(16, "16");
        tree.add(15, "15");

        Node node15 = (Node) tree.getNode(15);
        Assert.assertEquals(7, node15.left.key);
        Assert.assertEquals(16, node15.right.key);
        ...
        Node node9 = (Node) tree.getNode(9);
        Assert.assertEquals(8, node9.left.key);
        Assert.assertEquals(11, node9.right.key);
    }
}
