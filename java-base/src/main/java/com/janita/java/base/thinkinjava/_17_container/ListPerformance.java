 ...
 *   100      18      12      12      19     476      63
 *  1000      25      11      12      37    2243      77
 * 10000      11      11      12     334     808     590
 * --------------------- LinkedList ---------------------
 *  size     add     get     set iterAdd  insert  remove
 *    10     102      27      26      21     120     114
 *   100       7      39      37       9      83      20
...
public class ListPerformance {
    ...
    static class ListTester extends Tester<List<Integer>> {
        ...
        public static void run(List<Integer> list, List<Test<List<Integer>>> tests) {
            ListTester listTester = new ListTester(list, tests);
            listTester.timedTest();
        }
    }
